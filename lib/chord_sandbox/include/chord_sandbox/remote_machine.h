...
namespace chord_sandbox {
     ...
     */
    struct MachineExit {
        tempo_utils::StatusCode statusCode;         /**< Status code returned by the machine. */
    };
    ...
    public:
        ...
        tempo_utils::Result<MachineExit> runUntilFinished(
            RemoteMachineStateChangedFunc func = nullptr,
            void *data = nullptr);
