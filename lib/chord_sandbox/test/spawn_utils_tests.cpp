...
TEST(SpawnUtils, SpawnTemporaryAgent)
{
    ...
    auto status = chord_sandbox::internal::spawn_temporary_agent(agentParams, agentPath,
        transport, agentServerName, runDirectory, pemCertificateFile, pemPrivateKeyFile, pemRootCABundleFile,
        spawnFunc);
